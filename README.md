...
| :---: | :--- | :---: |
| 🤖 **Android** | Usuários finais (versão estável) | [**`DMovel.apk`**](#) |
| 🧑‍💻 **Android (Dev)** | Desenvolvedores e testadores | [**`DMovel-Dev.apk`**](https://github.com/LAPSHub/dmovel_web_app/releases/download/v1.0.0%2B14-android/DMovel-Dev.apk) |
| 🍏 **iOS** | Usuários de iPhone/iPad | [**`dmovelapp.ipa`**](#) |
