![DMovel Banner](assets/banner.png)
# 📱 DMovel

**Android e Web, com acesso rápido e direto. Leve o poder do sistema DMóvel para onde você for.**
...
| :---: | :--- | :---: |
| 🤖 **Android** | Usuários finais (versão estável) | [**DMovel.apk**](https://github.com/LAPSHub/dmovel_web_app/releases/download/v1.0.2%2B20-android/DMovel.apk) |
| 🧑‍💻 **Android (Dev)** | Desenvolvedores e testadores | [**DMovel-Dev.apk**](https://github.com/LAPSHub/dmovel_web_app/releases/download/v1.0.2%2B23-android/DMovel-Dev.apk) |
| 🍏 **iOS** | Usuários finais (versão estável) | [**dmovelapp.ipa**](https://github.com/LAPSHub/dmovel_web_app/releases/download/v1.0.0%2B12/dmovelapp.ipa) |
| 🧑‍💻 **iOS (Dev)** | Desenvolvedores e testadores | [**DMovel-Dev.ipa**](#) |
...
1. Baixe o arquivo  desejado no seu celular.
   - : aparelhos ARM64 modernos.
   - : aparelhos ARM 32-bit antigos.
   - : emuladores/dispositivos x86_64.
...
⚠️ **Atenção:** A instalação de apps  fora da App Store é restrita pela Apple.
...
- **iOS é diferente:** Apenas dispositivos autorizados podem instalar  manualmente. Para a maioria dos usuários, a versão Web é a melhor alternativa no ecossistema Apple.
